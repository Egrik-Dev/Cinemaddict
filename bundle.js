...
/* harmony import */ var _models_movie_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/movie.js */ "./src/models/movie.js");
...
class Api {
  ...
  getFilms() {
    return this._load({url: `movies`})
      ...
      .then(_models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies);
  }
  ...
  updateFilm(id, movie) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie);
  }
...
class Provider {
  ...
  getFilms() {
    ...
    return Promise.resolve(_models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies(storeMovies));
  }
  ...
  getComments(id) {
    ...
    if (store[id][`comments`].length === 0) {
      ...
      return Promise.resolve(_models_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(store[id][`comments`]));
    }
  }
  ...
  createComment(id, comment) {
    if (this.isOnline()) {
      return this._api.createComment(id, comment)
        .then((newComment) => _models_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComment(newComment))
        .then((commentModel) => {
    ...
    const fakeNewComment = _models_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComment(Object.assign({}, comment.toRAW(), {
  ...
  updateFilm(id, movie) {
    ...
    const fakeUpdatedMovie = _models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie(Object.assign({}, movie.toRAW(), {id}));
...
class Avatar extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films) {
    super();
    this._films = films;
  }
...
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
/* harmony import */ var _utils_time_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/time.js */ "./src/utils/time.js");
...
const createMovieCardTemplate = (film) => {
  ...
  const filteredComments = Object(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["filterComments"])(comments);

  return (`<article class="film-card">
      <h3 class="film-card__title">${title}</h3>
      <p class="film-card__rating">${totalRating}</p>
      <p class="film-card__info">
        <span class="film-card__year">${Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_1__["formatYear"])(release.date)}</span>
        <span class="film-card__duration">${Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_1__["formatDuration"])(runtime)}</span>
      ...
      <a class="film-card__comments">${filteredComments.length} comments</a>
...
/***/ "./src/components/film-list-extra.js":
/*!*******************************************!*\
  !*** ./src/components/film-list-extra.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmListExtra; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class FilmListExtra extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(title) {
    super();
    this._title = title;
  }
...
class FilmList extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/*!**********************************!*\
  !*** ./src/components/filter.js ***!
  \**********************************/
/*! exports provided: MenuType, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class Filter extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters) {
    super();
  ...
  return comments.map((comment) => {
    return (
      `<li class="film-details__comment" id="${comment.id}">
        ...
        <div>
          <p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(comment.comment)}</p>
          <p class="film-details__comment-info">
            <span class="film-details__comment-author">${comment.author}</span>
            <span class="film-details__comment-day">${Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_1__["commentDate"])(comment.date)}</span>
          ...
          <div class="film-details__info">
            ...
            <table class="film-details__table">
              ...
              <tr class="film-details__row">
                ...
                <td class="film-details__cell">${Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_1__["formatReleaseDate"])(release.date)}</td>
              </tr>
              <tr class="film-details__row">
                <td class="film-details__term">Runtime</td>
                <td class="film-details__cell">${Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_1__["formatDuration"])(runtime)}</td>
              </tr>
              <tr class="film-details__row">
...
class ShowMore extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const renderChart = (chartCtx, genres) => {
  chart_js__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.global.defaultFontColor = ChartSettings.FONT_COLOR;
  chart_js__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.global.defaultFontFamily = ChartSettings.FONT_FAMILY;
  chart_js__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.global.defaultFontSize = ChartSettings.FONT_SIZE;
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(chartCtx, {
...
const createStatisticsTemplate = (films, activeStatisticsType, genres) => {
  ...
  const totalHours = Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_1__["getTotalHours"])(totalDuration);
  const restMinutes = Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_1__["getRestOfMinutes"])(totalDuration);
...
/* harmony import */ var _utils_filters_sort__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/filters-sort */ "./src/utils/filters-sort.js");
...
class FilterController {
  constructor(container, moviesModel) {
    ...
    this._activeFilterType = _utils_filters_sort__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL;
  ...
  render() {
    ...
    const filters = Object.values(_utils_filters_sort__WEBPACK_IMPORTED_MODULE_0__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filters_sort__WEBPACK_IMPORTED_MODULE_0__["getMoviesByFilter"])(allFilms, filterType).length,
        checked: this._activeFilterType === filterType,
      };
    });

    const oldFilterComponent = this._filterComponent;
    this._filterComponent = new _components_filter_js__WEBPACK_IMPORTED_MODULE_1__["default"](filters);
    this._filterComponent.setFilterClickHandler(this._setFilterChangeHandler);

    return (oldFilterComponent) ? Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filterComponent, oldFilterComponent) : Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
  }
...
/* harmony import */ var _utils_time__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/time */ "./src/utils/time.js");
...
const parseFormData = (formData, film) => {
  return new _models_movie__WEBPACK_IMPORTED_MODULE_2__["default"]({
    'id': film.id,
    'film_info': {
      'title': film.title,
...
class MovieController {
  ...
  render(film) {
    ...
    this._filmComponent.setWatchlistClickHandler(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_2__["default"].clone(film);
    ...
    this._filmComponent.setAswatchedClickHandler(() => {
      ...
      newMovie.watchingDate = Object(_utils_time__WEBPACK_IMPORTED_MODULE_5__["parseToJson"])(Date.now());
      this._onDataChange(this, film, newMovie);
    });
    ...
    if (oldFilmComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._filmContainer, this._filmComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
    }
  }

  setDefaultView() {
    if (this._mode !== Mode.DEFAULT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this.popupComponent);
      this.popupComponent = null;
      this._mode = Mode.DEFAULT;
  ...
  _addNewComment() {
    ...
    const newCommentModel = new _models_comment__WEBPACK_IMPORTED_MODULE_3__["default"]({
      emotion: this.popupComponent.emoji,
      comment: this.popupComponent.currentComment,
      date: Object(_utils_time__WEBPACK_IMPORTED_MODULE_5__["parseToJson"])(Date.now())
    });
  ...
  _renderPopupComponent() {
    ...
    .then((comments) => {
      ...
      this.popupComponent = new _components_popup_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.film);
      this._setPopupHandlers();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._popupContainer, this.popupComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTEREND);
    });
  }
  ...
  _setPopupHandlers() {
    ...
    this.popupComponent.setIsWatchedClickHandler(() => {
      ...
      this.film.watchingDate = Object(_utils_time__WEBPACK_IMPORTED_MODULE_5__["parseToJson"])(Date.now());
    ...
    this.popupComponent.setInputRatingClickHandler((currentRating) => {
      ...
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_2__["default"].clone(this.film);
...
/* harmony import */ var _components_film_list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/film-list.js */ "./src/components/film-list.js");
/* harmony import */ var _components_show_more_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/show-more.js */ "./src/components/show-more.js");
/* harmony import */ var _components_film_list_extra_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/film-list-extra.js */ "./src/components/film-list-extra.js");
/* harmony import */ var _components_no_films__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/no-films */ "./src/components/no-films.js");
/* harmony import */ var _movie_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./movie-controller.js */ "./src/controllers/movie-controller.js");
...
const renderFilms = (FilmComponentContainer, PopupComponentConatainer, films, onDataChange, onViewChange, api) => {
  return films.map((film) => {
    const movieControllerComponent = new _movie_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](FilmComponentContainer, PopupComponentConatainer, onDataChange, onViewChange, api);
...
class PageController {
  constructor(container, moviesModel, api) {
    ...
    this._filmListComponent = new _components_film_list_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._filmListTopRated = new _components_film_list_extra_js__WEBPACK_IMPORTED_MODULE_2__["default"](`Top rated`);
    this._filmListMostCommented = new _components_film_list_extra_js__WEBPACK_IMPORTED_MODULE_2__["default"](`Most commented`);
    this._showMoreComponent = new _components_show_more_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  render() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container.getElement(), this._filmListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
    ...
    if (this._noFilmsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._noFilmsComponent);
    }

    if (this._films.length === 0) {
      this._noFilmsComponent = new _components_no_films__WEBPACK_IMPORTED_MODULE_3__["default"](this._isLoading);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._allMoviesListElement, this._noFilmsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].AFTEREND);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container.getElement(), this._filmListTopRated, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container.getElement(), this._filmListMostCommented, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  ...
  _renderShowMore() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._showMoreComponent);

    if (this._moviesModel.getFilms().length > START_RENDER_FILMS_COUNT) {
      this._showMoreComponent = new _components_show_more_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._allMoviesListElement, this._showMoreComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].AFTEREND);
...
/***/ "./src/controllers/sort-controller.js":
/*!********************************************!*\
  !*** ./src/controllers/sort-controller.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SortController; });
...
class SortController {
  ...
  render() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
...
/* harmony import */ var _components_statistics_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/statistics.js */ "./src/components/statistics.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _utils_filters_sort_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/filters-sort.js */ "./src/utils/filters-sort.js");
/* harmony import */ var _utils_const__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/const */ "./src/utils/const.js");
/* harmony import */ var _utils_time_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/time.js */ "./src/utils/time.js");
...
class StatisticsController {
  constructor(container, moviesModel) {
    ...
    this._activeStatisticsType = _utils_const__WEBPACK_IMPORTED_MODULE_3__["StatisticsType"].ALL;
    this._moviesModel.setDataChangeHandler(this._setDataChangeHandler);
  }

  render() {
    const oldStatisticsComponent = this._statisticsComponent;
    const dateFrom = Object(_utils_time_js__WEBPACK_IMPORTED_MODULE_4__["getDateFrom"])(this._activeStatisticsType);
    const films = this._moviesModel.getStatisticFilms(dateFrom);
    const genres = Object(_utils_filters_sort_js__WEBPACK_IMPORTED_MODULE_2__["getGenresList"])(films);
    const statisticsTypes = Object.values(_utils_const__WEBPACK_IMPORTED_MODULE_3__["StatisticsType"]).map((statisticsType) => {
      return {
        name: statisticsType,
    ...
    this._statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_0__["default"](films, statisticsTypes, genres);

    this._statisticsComponent.setStatisticClickHandler(this._setStatisticsTypeChangeHandler);
    if (oldStatisticsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._statisticsComponent, oldStatisticsComponent);
      this._statisticsComponent.createChart();
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      this._statisticsComponent.createChart();
    }
  }
...
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
/* harmony import */ var _api_store_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api/store.js */ "./src/api/store.js");
...
/* harmony import */ var _components_films_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/films.js */ "./src/components/films.js");
...
/* harmony import */ var _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controllers/filter-controller.js */ "./src/controllers/filter-controller.js");
/* harmony import */ var _controllers_sort_controller__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controllers/sort-controller */ "./src/controllers/sort-controller.js");
/* harmony import */ var _controllers_statistics_controller_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./controllers/statistics-controller.js */ "./src/controllers/statistics-controller.js");
...
/* harmony import */ var _utils_filters_sort_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils/filters-sort.js */ "./src/utils/filters-sort.js");
...
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_2__["default"](CACHE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_1__["default"](api, store);
...
const filmsComponent = new _components_films_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const pageControllerComponent = new _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_5__["default"](filmsComponent, moviesModel, apiWithProvider);
const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"](mainMenuElement, moviesModel);
const sortController = new _controllers_sort_controller__WEBPACK_IMPORTED_MODULE_7__["default"](mainMenuElement, moviesModel);
const statisticsController = new _controllers_statistics_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"](mainMenuElement, moviesModel);

filterController.render();
sortController.render();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(mainMenuElement, filmsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
...
apiWithProvider.getFilms()
  .then((films) => {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(headerElement, new _components_avatar_js__WEBPACK_IMPORTED_MODULE_3__["default"](films), _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
...
filterController.setMenuTypeClickHandler((menuType) => {
  switch (menuType) {
    case _utils_filters_sort_js__WEBPACK_IMPORTED_MODULE_11__["MenuType"].FILTER:
      pageControllerComponent.show();
      sortController.show();
      statisticsController.hide();
      break;
    case _utils_filters_sort_js__WEBPACK_IMPORTED_MODULE_11__["MenuType"].STATS:
...
class Movie {
  constructor(movie) {
    ...
    this.watchingDate = movie.user_details[`watching_date`] || Object(_utils_time__WEBPACK_IMPORTED_MODULE_0__["parseToJson"])(Date.now());
...
class Movies {
  ...
  getFilms() {
    const filteredFilms = Object(_utils_filters_sort__WEBPACK_IMPORTED_MODULE_0__["getMoviesByFilter"])(this._films, this._activeFilterType);
    return this.getSortedFilms(filteredFilms);
  }

  getSortedFilms(filteredFilms) {
    return Object(_utils_filters_sort__WEBPACK_IMPORTED_MODULE_0__["getMoviesBySort"])(filteredFilms, this._activeSortType);
  }

  getStatisticFilms(dateFrom) {
    return Object(_utils_filters_sort__WEBPACK_IMPORTED_MODULE_0__["getMoviesByStatistic"])(this._films, dateFrom);
  }
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: StatisticsType, filterComments */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticsType", function() { return StatisticsType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filterComments", function() { return filterComments; });
...
/***/ "./src/utils/filters-sort.js":
/*!***********************************!*\
  !*** ./src/utils/filters-sort.js ***!
  \***********************************/
/*! exports provided: MenuType, FilterType, getWatchlistFilms, getHistoryFilms, getFavoritesFilms, getMoviesByFilter, getMoviesBySort, getMoviesByStatistic, getGenresList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMoviesBySort", function() { return getMoviesBySort; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMoviesByStatistic", function() { return getMoviesByStatistic; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGenresList", function() { return getGenresList; });
const MenuType = {
  FILTER: `filter`,
  STATS: `stats`
};
...
const getMoviesBySort = (films, sortType) => {
  switch (sortType) {
...
const getMoviesByStatistic = (films, dateFrom) => {
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, render, remove, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***************************!*\
  !*** ./src/utils/time.js ***!
  \***************************/
/*! exports provided: formatYear, formatDuration, getTotalHours, getRestOfMinutes, formatReleaseDate, getDateFrom, parseToJson, commentDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTotalHours", function() { return getTotalHours; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRestOfMinutes", function() { return getRestOfMinutes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatReleaseDate", function() { return formatReleaseDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDateFrom", function() { return getDateFrom; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseToJson", function() { return parseToJson; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "commentDate", function() { return commentDate; });
...
const formatDuration = (runtime) => {
  const time = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(runtime, `m`);
...
const getTotalHours = (runtime) => {
  return Math.floor(runtime / MINUTES_IN_HOURS);
};

const getRestOfMinutes = (runtime) => {
...
const getDateFrom = (period) => {
  switch (period) {
    case PeriodTime.TODAY:
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(`day`)).format();
    case PeriodTime.WEEK:
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(7, `days`)).format();
    case PeriodTime.MONTH:
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(1, `months`)).format();
    case PeriodTime.YEAR:
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(1, `years`)).format();
    default:
      return period;
  }
};

const parseToJson = (date) => moment__WEBPACK_IMPORTED_MODULE_0___default()(date).toJSON();

const commentDate = (date) => {
  const now = Date.now();
  const diff = moment__WEBPACK_IMPORTED_MODULE_0___default()(now).diff(date, `minutes`);
  if (diff === 0) {
